...
extern GType fb_mqtt_get_type(void);
extern GType fb_mqtt_message_get_type(void);
extern GType fb_json_values_get_type(void);
extern GType fb_thrift_get_type(void);
extern GType fb_api_get_type(void);
extern GType fb_api_thread_get_type(void);
extern GType fb_api_user_get_type(void);
...
extern GQuark fb_http_error_quark(void);
extern GQuark fb_util_error_quark(void);
extern GQuark fb_mqtt_error_quark(void);
extern GQuark fb_mqtt_ssl_error_quark(void);
extern GQuark fb_json_error_quark(void);
extern GQuark fb_api_error_quark(void);
