 ...
 *
 * The maximum amount of threads to fetch. If this
 * value is set too high, HTTP request will fail. This is due to the
 * request data being too large.
 */
#define FB_API_THREADS_COUNT  500
 ...
 * @is_friend: Is the user our friend
 *
...
/**
 * fb_api_new:
 * @gc: (transfer full): The #GSocketClient.
 * @ses: (transfer full): The #SoupSession
 *
 ...
 * fb_api_threads:
 * @api: The #FbApi.
 * @count: The number of threads to request
 *
...
#define fb_api_event_copy fb_api_event_dup
...
#define fb_api_event_destroy fb_api_event_free
...
#define fb_api_message_copy fb_api_message_dup
...
#define fb_api_message_destroy fb_api_message_free
...
#define fb_api_presence_copy fb_api_presence_dup
...
#define fb_api_presence_destroy fb_api_presence_free

/**
 * fb_api_thread_get_type:
 * Returns: The type of #FbApiThread
 */
GType
...
#define fb_api_typing_copy fb_api_typing_dup
...
#define fb_api_typing_destroy fb_api_typing_free

/**
 * fb_api_user_get_type:
 * Returns: The type of #FbApiUser
 */
GType
