 ...
 * FbHttpConns:
 *
 * Represents a set of #SoupRequestHTTP.
 */
 ...
 * the any of the added #SoupRequestHTTP.
 */
void
 ...
 * @cons: The #FbHttpConns.
 *
 * Cancels each #SoupRequestHTTP in the #FbHttpConns.
 */
void
 ...
 * fb_http_conns_add:
 * @cons: The #FbHttpConns.
 * @con: The #SoupRequestHTTP.
 *
 * Adds a #SoupRequestHTTP to the #FbHttpConns.
 */
void
 ...
 * @con: The #SoupRequestHTTP.
 *
 * Removes a #SoupRequestHTTP from the #FbHttpConns.
 */
void
 ...
 * @cons: The #FbHttpConns.
 *
 * Resets the #FbHttpConns. This removes each #SoupRequestHTTP
...
/**
  * fb_http_extract_data:
  * @req: The #SoupRequestHTTP.
  * @res: The #GAsyncResult.
  * @err: The return location for the #GError or #NULL.
  *
  * Reads response data from request stream and writes it to the
  * associated message.
  */
void
