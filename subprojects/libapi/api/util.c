...
fb_util_debug_misc(const gchar *format, ...)
{
	...
	va_start(ap, format);
    fb_util_vdebug(G_LOG_LEVEL_MESSAGE, format, ap);
	va_end(ap);
}
...
fb_util_debug_info(const gchar *format, ...)
{
	...
	va_start(ap, format);
    fb_util_vdebug(G_LOG_LEVEL_INFO, format, ap);
	va_end(ap);
}
...
fb_util_debug_warning(const gchar *format, ...)
{
	...
	va_start(ap, format);
    fb_util_vdebug(G_LOG_LEVEL_WARNING, format, ap);
	va_end(ap);
}
...
fb_util_debug_error(const gchar *format, ...)
{
	...
	va_start(ap, format);
    fb_util_vdebug(G_LOG_LEVEL_ERROR, format, ap);
	va_end(ap);
}
...
fb_util_debug_fatal(const gchar *format, ...)
{
	...
	va_start(ap, format);
    fb_util_vdebug(G_LOG_LEVEL_CRITICAL, format, ap);
	va_end(ap);
}
